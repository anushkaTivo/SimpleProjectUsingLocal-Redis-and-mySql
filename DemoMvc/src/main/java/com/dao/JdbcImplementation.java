...
public class JdbcImplementation {
	...
	public static  String insertQuery,selectQuery;
	{
		
		insertQuery="insert into ";
		insertQuery = insertQuery.concat(tableName);
		insertQuery = insertQuery.concat(" (id,name) values(?,?)");
		
		selectQuery = "select * from ";
		selectQuery = selectQuery.concat(tableName);
		selectQuery = selectQuery.concat(" where id=?");
	}
	
	/*
	 * public static final String insertQuery = q; public static final String
	 * selectQuery = s;
	 */
