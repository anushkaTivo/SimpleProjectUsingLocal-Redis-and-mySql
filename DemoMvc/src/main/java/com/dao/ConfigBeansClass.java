...
public class ConfigBeansClass {
	...
	public StudentDataModel giveStuObj() {
	 ...
	 @Bean public Jedis giveJedisObj() { 
		 return new HelpersCache().returnJedis();
	 }
	 
	
	 
	/*
	 * THIS IS ONLY APPLICABLE FOR AWS SERVICES LOCALHOST NOT SUPPORTING CLUSTER
	 * @Bean public JedisCluster giveJedisPoolObj() { return new
	 * HelpersCache().returnJedisCluster(); }
	 */
